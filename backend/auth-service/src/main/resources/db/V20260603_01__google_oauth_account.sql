-- Flyway-style migration for Google OAuth account binding.
-- The current auth schema stores external identities in af_oauth_account.
-- Google uses:
--   provider = 'GOOGLE'
--   provider_user_id = Google subject (sub)
