...
export const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    catalog: 'node',
    group: 'recommended',
    config: { query: '', dataset: '', metadataFilter: 'disabled', topK: 5, rerank: true },
    inputs: ['query.text'],
    outputs: ['context.text', 'hits.json'],
  },
  {
    kind: 'output',
    label: 'Output',
    ...
    catalog: 'node',
    group: 'recommended',
    config: { outputName: 'answer', outputValue: '', responseMode: 'text', exposeArtifacts: true },
    inputs: ['result.text'],
