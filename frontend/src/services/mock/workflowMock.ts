...
export const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    kind: 'upload',
    label: 'File Input',
    description: 'Read tenant-owned file metadata and expose fileUrl to downstream nodes.',
    category: 'Media',
    catalog: 'node',
    group: 'recommended',
  ...
  },
  {
    ...
    catalog: 'node',
    group: 'recommended',
    config: { urlVariable: 'websiteUrl', maxChars: 20000, outputVariable: 'urlText' },
    inputs: ['websiteUrl'],
  ...
  },
  {
    kind: 'notify',
    label: 'Notify',
    description: 'Send a workflow completion notification to a user.',
    category: 'Output',
    catalog: 'node',
    group: 'recommended',
    config: { channel: 'WORKFLOW', eventType: 'WORKFLOW_COMPLETED', payload: { title: 'Workflow completed' } },
    inputs: ['userId'],
    outputs: ['notified', 'eventType'],
  },
  {
    kind: 'knowledge-retrieval',
    label: 'Knowledge Retrieval',
    description: 'Retrieve top-k chunks from a configured knowledge dataset.',
    category: 'AI',
    catalog: 'node',
    group: 'recommended',
  ...
  },
  {
    ...
    catalog: 'node',
    group: 'recommended',
    config: { outputName: 'answer', outputValue: 'summary' },
    inputs: ['summary'],
    outputs: ['output'],
  },
  {
  ...
  },
  {
    ...
    catalog: 'tool',
    group: 'allTools',
    config: { language: 'python3', code: 'def main(arg1: str, arg2: str):\n    return {"result": arg1 + arg2}', outputVariable: 'codeResult', timeoutSec: 30 },
    inputs: ['payload.json'],
  ...
  },
  {
    ...
    catalog: 'tool',
    group: 'allTools',
    config: { template: '{{ arg1 }}', outputVariable: 'renderedText' },
    inputs: ['context.json'],
  ...
  },
  {
    ...
    catalog: 'tool',
    group: 'allTools',
    config: { variables: 'left,right', outputVariable: 'merged' },
