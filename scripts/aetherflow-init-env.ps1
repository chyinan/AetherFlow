...
$content = Set-EnvValue $content 'WORKFLOW_QDRANT_ENABLED' 'true'
$content = Set-EnvValue $content 'WORKFLOW_KNOWLEDGE_VECTOR_INDEX_REQUIRED' 'true'
$content = Set-EnvValue $content 'TASK_QUEUE_FAIL_CLOSED' 'true'
$content = Set-EnvValue $content 'NOTIFY_MAX_SSE_CONNECTIONS_PER_USER' '20'
$content = Set-EnvValue $content 'NOTIFY_MAX_WS_CONNECTIONS' '2000'
$content = Set-EnvValue $content 'NOTIFY_MAX_WS_CONNECTIONS_PER_USER' '10'
