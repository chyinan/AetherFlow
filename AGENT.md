...
| BE-WORKFLOW-RUN-QUERY-20260529 | Workflow Instance List / Detail / Log Query API | REVIEW | 陈胤安 | chyinan | feature/BE-WORKFLOW-RUN-QUERY-20260529-run-query | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowInstanceController.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowInstanceQueryService.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImpl.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/dto/WorkflowInstanceRunDtos.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowInstanceControllerTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImplTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java；docs/agent/tasks/BE-WORKFLOW-RUN-QUERY-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | 是，仅 workflow-service instance query REST API | git diff --check 通过；目标测试 8 tests 通过；mvn -pl backend/workflow-service -am test 通过，workflow-service 101 tests | 2026-05-29 17:38 |
...
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowInstanceController.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query controller |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowInstanceQueryService.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query service contract |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImpl.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query service implementation |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/dto/WorkflowInstanceRunDtos.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance run query DTO |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowInstanceControllerTest.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query controller tests |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImplTest.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query service tests |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | Workflow instance query OpenAPI contract tests |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | docs/agent/tasks/BE-WORKFLOW-RUN-QUERY-20260529.md | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | 任务文档 |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | docs/agent/logs/2026-05-29.md | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | 当日执行日志 |
| BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | AGENT.md | 2026-05-29 17:28 | 2026-05-29 17:38 | RELEASED | 任务看板、契约登记与文件锁 |
...
| REST API | GET /workflow-instances；GET /workflow-instances/{id}；GET /workflow-instances/{id}/logs | workflow-service | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowInstanceController.java | APPROVED | 陈胤安 | 陈胤安 |
...
| BE-WORKFLOW-RUN-QUERY-20260529 | 静态检查 | git diff --check；git diff --cached --check | 通过 | 无 whitespace error，仅 Windows LF/CRLF 提示；修改文件限定在任务锁范围内 | chyinan | 2026-05-29 17:38 |
| BE-WORKFLOW-RUN-QUERY-20260529 | 目标测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/workflow-service -am -Dtest=WorkflowInstanceControllerTest,WorkflowInstanceQueryServiceImplTest,WorkflowOpenApiContractTest -Dsurefire.failIfNoSpecifiedTests=false test | 通过 | 8 tests；BUILD SUCCESS | chyinan | 2026-05-29 17:37 |
| BE-WORKFLOW-RUN-QUERY-20260529 | 单元测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/workflow-service -am test | 通过 | common 8 tests；workflow-runtime-api 10 tests；workflow-service 101 tests；BUILD SUCCESS | chyinan | 2026-05-29 17:37 |
...
| 2026-05-29 17:38 | BE-WORKFLOW-RUN-QUERY-20260529 | chyinan | 完成 workflow instance list/detail/log API：新增 run query controller/service/DTO，从 af_workflow_instance 与 RuntimeEventStore 聚合运行状态、traceId、timestamps、节点摘要和日志帧 | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowInstanceController.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowInstanceQueryService.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImpl.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/dto/WorkflowInstanceRunDtos.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowInstanceControllerTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowInstanceQueryServiceImplTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java；docs/agent/tasks/BE-WORKFLOW-RUN-QUERY-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | `git diff --check` 通过；目标测试 8 tests 通过；`mvn -pl backend/workflow-service -am test` 通过，workflow-service 101 tests | feature/BE-WORKFLOW-RUN-QUERY-20260529-run-query；752126e claim；5b0fbef implementation | 未合入 | 未运行 | 需统一运行电脑补测真实 MySQL 数据、runtime event 聚合；字符串型前端 workflowId 的正式映射需后续项目/workspace 模型补齐 | RELEASED |
