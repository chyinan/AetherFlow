...
| BE-STREAM-AUTH-20260529 | Secure Browser Stream Auth for Notify WebSocket | REVIEW | 陈胤安 | chyinan | feature/BE-STREAM-AUTH-20260529-stream-auth | backend/notify-service/src/main/java/com/aetherflow/notify/controller/NotifyController.java；backend/notify-service/src/main/java/com/aetherflow/notify/config/WebSocketConfig.java；backend/notify-service/src/main/java/com/aetherflow/notify/config/NotifySecurityConfig.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/NotificationWebSocketHandler.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenService.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenHandshakeInterceptor.java；backend/notify-service/src/main/java/com/aetherflow/notify/dto/StreamTokenResponse.java；backend/notify-service/src/test/java/com/aetherflow/notify/controller/NotifyControllerTest.java；backend/notify-service/src/test/java/com/aetherflow/notify/service/StreamTokenServiceTest.java；backend/notify-service/src/test/java/com/aetherflow/notify/service/StreamTokenHandshakeInterceptorTest.java；backend/notify-service/src/test/java/com/aetherflow/notify/openapi/NotifyOpenApiContractTest.java；backend/gateway-service/src/main/resources/application.yml；backend/gateway-service/src/main/java/com/aetherflow/gateway/config/GatewaySecurityProperties.java；backend/gateway-service/src/test/java/com/aetherflow/gateway/filter/JwtAuthenticationFilterTest.java；backend/gateway-service/src/test/java/com/aetherflow/gateway/GatewayRouteConfigurationTest.java；docs/agent/tasks/BE-STREAM-AUTH-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | 是，仅新增 POST /notify/stream-token、/notify/ws stream token query 校验、Gateway /notify/ws JWT 放行 | git diff --check 通过；目标测试通过；mvn -pl backend/notify-service,backend/gateway-service -am test 通过 | 2026-05-29 18:31 |
...
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/controller/NotifyController.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Stream token issuance API |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/config/WebSocketConfig.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Notify WS handshake interceptor |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/config/NotifySecurityConfig.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Notify JwtProperties config |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/service/NotificationWebSocketHandler.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | WS user identity from validated stream token |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenService.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | 短期 stream token 签发与校验 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenHandshakeInterceptor.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | WS handshake token 校验 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/main/java/com/aetherflow/notify/dto/StreamTokenResponse.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Stream token 响应 DTO |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/test/java/com/aetherflow/notify/controller/NotifyControllerTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Stream token controller 测试 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/test/java/com/aetherflow/notify/service/StreamTokenServiceTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Stream token service 测试 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/test/java/com/aetherflow/notify/service/StreamTokenHandshakeInterceptorTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Stream token handshake 测试 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/notify-service/src/test/java/com/aetherflow/notify/openapi/NotifyOpenApiContractTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Notify OpenAPI 合约测试 |
| BE-STREAM-AUTH-20260529 | chyinan | backend/gateway-service/src/main/resources/application.yml | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Gateway /notify/ws permit-all |
| BE-STREAM-AUTH-20260529 | chyinan | backend/gateway-service/src/main/java/com/aetherflow/gateway/config/GatewaySecurityProperties.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Gateway 默认 permit-all |
| BE-STREAM-AUTH-20260529 | chyinan | backend/gateway-service/src/test/java/com/aetherflow/gateway/filter/JwtAuthenticationFilterTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Gateway JWT permit test |
| BE-STREAM-AUTH-20260529 | chyinan | backend/gateway-service/src/test/java/com/aetherflow/gateway/GatewayRouteConfigurationTest.java | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | Gateway notify WS route test |
| BE-STREAM-AUTH-20260529 | chyinan | docs/agent/tasks/BE-STREAM-AUTH-20260529.md | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | 任务文档 |
| BE-STREAM-AUTH-20260529 | chyinan | docs/agent/logs/2026-05-29.md | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | 当日执行日志 |
| BE-STREAM-AUTH-20260529 | chyinan | AGENT.md | 2026-05-29 18:20 | 2026-05-30 00:20 | RELEASED | 任务看板、契约登记与文件锁 |
...
| Notify Secure Stream Auth / REST API / Gateway Security | POST /notify/stream-token；/notify/ws?streamToken=...；Gateway /notify/ws permit-all with notify-service stream-token validation | notify-service；gateway-service | backend/notify-service/**；backend/gateway-service/src/main/resources/application.yml；backend/gateway-service/src/main/java/com/aetherflow/gateway/config/GatewaySecurityProperties.java | APPROVED | 陈胤安 | 陈胤安 |
...
| BE-STREAM-AUTH-20260529 | TDD 红灯 | mvn -pl backend/notify-service,backend/gateway-service -am -Dtest=NotifyControllerTest,StreamTokenServiceTest,StreamTokenHandshakeInterceptorTest,NotifyOpenApiContractTest,JwtAuthenticationFilterTest,GatewayRouteConfigurationTest -Dsurefire.failIfNoSpecifiedTests=false test | 未通过 | Gateway `/notify/ws` 未放行，Notify token/interceptor 类缺失，符合预期 | chyinan | 2026-05-29 18:25 |
| BE-STREAM-AUTH-20260529 | 目标测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/notify-service,backend/gateway-service -am -Dtest=NotifyControllerTest,StreamTokenServiceTest,StreamTokenHandshakeInterceptorTest,NotifyOpenApiContractTest,JwtAuthenticationFilterTest,GatewayRouteConfigurationTest -Dsurefire.failIfNoSpecifiedTests=false test | 通过 | gateway-service 12 tests；notify-service 6 tests；BUILD SUCCESS | chyinan | 2026-05-29 18:30 |
| BE-STREAM-AUTH-20260529 | 单元测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/notify-service,backend/gateway-service -am test | 通过 | common 8 tests；gateway-service 19 tests；notify-service 6 tests；BUILD SUCCESS | chyinan | 2026-05-29 18:31 |
| BE-STREAM-AUTH-20260529 | 静态检查 | git diff --check；git diff --name-only main...HEAD | 通过 | 无 whitespace error，仅 Windows LF/CRLF 提示；修改限定在任务允许文件 | chyinan | 2026-05-29 18:31 |
...
| 2026-05-29 18:31 | BE-STREAM-AUTH-20260529 | chyinan | 完成 Notify Browser WebSocket secure stream auth：短期 stream token issuance、WS handshake token 校验、Gateway `/notify/ws` 放行并保持其他 notify API JWT 鉴权 | backend/notify-service/src/main/java/com/aetherflow/notify/controller/NotifyController.java；backend/notify-service/src/main/java/com/aetherflow/notify/config/WebSocketConfig.java；backend/notify-service/src/main/java/com/aetherflow/notify/config/NotifySecurityConfig.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/NotificationWebSocketHandler.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenService.java；backend/notify-service/src/main/java/com/aetherflow/notify/service/StreamTokenHandshakeInterceptor.java；backend/notify-service/src/main/java/com/aetherflow/notify/dto/StreamTokenResponse.java；backend/notify-service/src/test/java/com/aetherflow/notify/**；backend/gateway-service/src/main/resources/application.yml；backend/gateway-service/src/main/java/com/aetherflow/gateway/config/GatewaySecurityProperties.java；backend/gateway-service/src/test/java/com/aetherflow/gateway/**；docs/agent/tasks/BE-STREAM-AUTH-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | 目标测试通过；`mvn -pl backend/notify-service,backend/gateway-service -am test` 通过，common 8 tests、gateway-service 19 tests、notify-service 6 tests；`git diff --check` 通过 | feature/BE-STREAM-AUTH-20260529-stream-auth；8001e03 claim；8275135 business | 未合入 | 未运行 | 需统一运行电脑补测真实 Gateway WS upgrade、notify-service handshake、JWT/stream token 链路；前端 WS fallback 未开启 | RELEASED |
