...
| BE-GW-WORKFLOW-ROUTE-20260529 | Workflow Runtime / Node API Gateway Route | REVIEW | 陈胤安 | chyinan | feature/BE-GW-WORKFLOW-ROUTE-20260529-workflow-route | backend/gateway-service/src/main/resources/application.yml；backend/gateway-service/src/test/java/com/aetherflow/gateway/GatewayRouteConfigurationTest.java；docs/agent/tasks/BE-GW-WORKFLOW-ROUTE-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | 是，仅 Gateway 路由 /workflow/** -> workflow-service | git diff --check；mvn -pl backend/gateway-service -am -Dtest=GatewayRouteConfigurationTest test；mvn -pl backend/gateway-service -am test | 2026-05-29 17:11 |
