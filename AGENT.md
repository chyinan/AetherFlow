...
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | Workflow Definitions List / Detail / Update / Delete API | REVIEW | 陈胤安 | chyinan | feature/BE-WORKFLOW-DEFINITION-CRUD-20260529-definition-crud | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowController.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowService.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowServiceImpl.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowServiceImplTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowControllerTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java；docs/agent/tasks/BE-WORKFLOW-DEFINITION-CRUD-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | 是，仅 workflow-service definitions CRUD REST API | git diff --check；mvn -pl backend/workflow-service -am -Dtest=WorkflowControllerTest,WorkflowServiceImplTest,WorkflowOpenApiContractTest test；mvn -pl backend/workflow-service -am test | 2026-05-29 17:23 |
...
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowController.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD controller |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowService.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD service contract |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowServiceImpl.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD service implementation |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowServiceImplTest.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD service tests |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowControllerTest.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD controller tests |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | Workflow definitions CRUD OpenAPI contract tests |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | docs/agent/tasks/BE-WORKFLOW-DEFINITION-CRUD-20260529.md | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | 任务文档 |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | docs/agent/logs/2026-05-29.md | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | 当日执行日志 |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | AGENT.md | 2026-05-29 17:15 | 2026-05-29 17:23 | RELEASED | 任务看板、契约登记与文件锁 |
...
| REST API | GET /workflows/definitions；GET /workflows/definitions/{id}；PUT /workflows/definitions/{id}；DELETE /workflows/definitions/{id} | workflow-service | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowController.java | APPROVED | 陈胤安 | 陈胤安 |
...
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | 静态检查 | git diff --check | 通过 | 无 whitespace error，仅 Windows LF/CRLF 提示 | chyinan | 2026-05-29 17:22 |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | 目标测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/workflow-service -am -Dtest=WorkflowControllerTest,WorkflowServiceImplTest,WorkflowOpenApiContractTest '-Dsurefire.failIfNoSpecifiedTests=false' test | 通过 | WorkflowControllerTest 4 tests；WorkflowServiceImplTest 7 tests；WorkflowOpenApiContractTest 1 test；BUILD SUCCESS | chyinan | 2026-05-29 17:22 |
| BE-WORKFLOW-DEFINITION-CRUD-20260529 | workflow-service 单元测试 | JAVA_HOME=C:\Program Files\Microsoft\jdk-17.0.19.10-hotspot; mvn -pl backend/workflow-service -am test | 通过 | common 8 tests；workflow-runtime-api 10 tests；workflow-service 103 tests；BUILD SUCCESS | chyinan | 2026-05-29 17:22 |
...
| 2026-05-29 17:23 | BE-WORKFLOW-DEFINITION-CRUD-20260529 | chyinan | 补齐 Workflow definitions list/detail/update/delete API：新增 GET list/detail、PUT update、DELETE soft delete，支持 Builder 持久化回读，不改 DB 结构 | backend/workflow-service/src/main/java/com/aetherflow/workflow/controller/WorkflowController.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/WorkflowService.java；backend/workflow-service/src/main/java/com/aetherflow/workflow/service/impl/WorkflowServiceImpl.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/controller/WorkflowControllerTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/service/impl/WorkflowServiceImplTest.java；backend/workflow-service/src/test/java/com/aetherflow/workflow/openapi/WorkflowOpenApiContractTest.java；docs/agent/tasks/BE-WORKFLOW-DEFINITION-CRUD-20260529.md；docs/agent/logs/2026-05-29.md；AGENT.md | `git diff --check` 通过；目标测试 12 tests 通过；`mvn -pl backend/workflow-service -am test` 通过，common 8 tests，workflow-runtime-api 10 tests，workflow-service 103 tests | 8ea899d claim；feat(workflow): add definition crud APIs | 未合入 | 未运行 | 需统一运行电脑补测真实 MySQL CRUD；run list/detail/log 仍待后续 P0 任务 | RELEASED |
